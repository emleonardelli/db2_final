 ...
 */
class Carrito extends \App\Entities\Carrito implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'cliente', 'productos', 'pagado', 'descripcion', 'fecha'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Carrito $proxy) {
    ...
    public function setFecha($data)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFecha', [$data]);

        return parent::setFecha($data);
    }
    ...
    public function setCliente($data)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCliente', [$data]);

        return parent::setCliente($data);
    }
    ...
    public function setDescripcion($data)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDescripcion', [$data]);

        return parent::setDescripcion($data);
    }
    ...
    public function setPagado($data)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPagado', [$data]);

        return parent::setPagado($data);
    }
